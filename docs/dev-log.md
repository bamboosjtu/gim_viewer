...
- **文档**：详见 [m4-research.md](m4-research.md) §6 用户核验流程 + §4.5 WIRE 拓扑分类 + §7 决策与后续路线。
...
>
> 决策记录与研究方法论见 [m4-research.md](m4-research.md)。
>
> 审计工具：`Ctrl+Shift+C` 导出 JSON + Markdown 摘要（详见 [m4-research.md](m4-research.md) §5 审计服务 API + §6 用户核验流程）。
...
- **后续路线**（详见 [m4-research.md](m4-research.md) §7.5 后续可能路线）：
