...
| 18b | C | 层级树/DEV SUBDEVICE 演进记录保留；文中 v14 为历史快照，当前 parser 版本为 v17 |
...
7. 17/18c 的部分段落仍保留旧版本号；当前源码以 `PARSER_VERSION=gim-parser-v17`、`GEOMETRY_CACHE_VERSION=geometry-cache-v4-phm-color` 为准，旧版本仅作历史记录。
