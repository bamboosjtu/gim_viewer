...
> **2026-08-24 十样本复核**：空 FAM 大规模存在——线路03 772 个（占其 .fam 的 11%）、
> 变电站02 659 个、变电站03 43 个。BASEFAMILY 指向空文件是正常形态而非引用损坏，
> 属性解析必须容忍 0 字节 FAM。FAM 覆盖率结论需按新样本重算后才能更新。详见 [22](22-ten-sample-verification-0824.md)。
