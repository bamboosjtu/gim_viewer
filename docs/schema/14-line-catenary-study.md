...
- 悬链线渲染：基于 15 号文档的 BLHA/KVALUE/MATRIX0 字段研究，实现导线弧垂可视化
- 线路 MOD 解析：基于 11 号文档的 4 类文本格式族 grammar，实现 parser
- 3D 线路渲染：基于杆塔位点 + 悬链线参数，实现 3D 线路展示
...
- **M4-B3C 收口**：悬链线不进入当前 MVP 实现范围。当前线路地图继续使用直线段。Ctrl+Shift+C 仅作为审计和后续研究工具
