...
> **2026-08-24 十样本复核**：DEV→DEV 组合引用的字段分野保持：变电走 SUBDEVICEn（4/4）、
> 线路走 SOLIDMODELn=*.dev（6/6）；但 DEV/PHM 数量对应关系随导出软件大幅变化，
> 不能用数量一致性做校验假设。详见 [22](22-ten-sample-verification-0824.md)。
